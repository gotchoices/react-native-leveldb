...
class SingletonEnv {
 public:
  SingletonEnv() {
    ...
    // compiling once C++20 made std::memory_order a scoped enum. Use the portable
    // top-level constant. Drop this patch if we re-vendor to a leveldb release
    // that already contains the fix (>1.23).
